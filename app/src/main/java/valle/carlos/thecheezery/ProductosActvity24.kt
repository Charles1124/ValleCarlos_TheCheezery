...
class ProductosActvity24 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_productos_actvity24)

        agregaProductos()

        var listView: ListView = findViewById(R.id.listview4)as ListView

        var adaptador: ProductosActvity24.AdaptadorProductos = ProductosActvity24.AdaptadorProductos(this, salties)
