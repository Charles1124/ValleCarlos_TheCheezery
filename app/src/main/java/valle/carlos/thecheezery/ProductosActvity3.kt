...
class ProductosActvity3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_productos_actvity3)

        agregaProductos()

        var listView: ListView = findViewById(R.id.listview3)as ListView

        var adaptador: ProductosActvity3.AdaptadorProductos = ProductosActvity3 .AdaptadorProductos(this, sweets)
